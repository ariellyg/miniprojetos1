...
class TestCofre(unittest.TestCase):
    ...
    def testInserirMoedaCofreQuebrado(self):
        cofre = Cofre(25)
        cofre.quebrar()
        self.assertFalse(cofre.addm(Moeda.M50), "Nao deve ser possivel adicionar uma moeda em um cofre quebrado")
    ...
    def testInserirMoeda(self):
        cofre = Cofre(10)
        self.assertTrue(cofre.addm(Moeda.M10), "Tem espaco sobrando, entao deve ser possivel adicionar o item")
    ...
    def testInserirItemEmCofreCheio(self):
        cofre = Cofre(4)
        cofre.addm(Moeda.M100)
        passporte = Item("Passaporte", 5)
        self.assertFalse(cofre.addm(Moeda.M10), "Nao deve ser possivel adicionar algo em um cofre cheio")
